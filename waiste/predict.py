...
def predict_image_classification_sample(
    ...
    # convierto la Image en un array
    image_arr = np.array(image)
    # la re-configuro para luego encodear
    jpg_img = cv2.imencode('.jpg', image_arr)
    # The format of each instance should conform to the deployed model's prediction input schema.
    encoded_content = base64.b64encode(jpg_img[1]).decode("utf-8")
